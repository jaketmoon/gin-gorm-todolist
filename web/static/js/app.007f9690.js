    ...
    0: function (e, t, n) {
        ...
        var l = function () {
                ...
                name: "TodoList", data: function () {
                    ...
                    var e = this;
                    this.axios.get("/Todo").then((function (t) {
                    ...
                    tableRowClassName: function (e) {
                        ...
                        this.axios.put("/Todo/" + t.id, {status: !t.status}).then((function () {
                        ...
                        var n = this;
                        this.axios.delete("/Todo/" + t).then((function () {
                        ...
                        var e = this;
                        "" != this.newTitle ? (this.axios.post("/Todo", {title: this.newTitle}).then((function () {
